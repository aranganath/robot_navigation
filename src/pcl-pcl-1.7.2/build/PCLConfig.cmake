...
macro(find_VTK)
  ...
  if(NOT ANDROID)
    ...
    if (VTK_FOUND)
      set(VTK_LIBRARIES "vtkImagingMath;vtkCommonDataModel;vtkCommonMath;vtkCommonCore;vtksys;vtkCommonMisc;vtkCommonSystem;vtkCommonTransforms;vtkCommonExecutionModel;vtkRenderingAnnotation;vtkFiltersSources;vtkCommonComputationalGeometry;vtkFiltersGeneral;vtkFiltersCore;vtkImagingColor;vtkImagingCore;vtkRenderingFreeType;vtkRenderingCore;vtkCommonColor;vtkFiltersExtraction;vtkFiltersStatistics;vtkImagingFourier;vtkalglib;vtkFiltersGeometry;/usr/lib/x86_64-linux-gnu/libfreetype.so;/usr/lib/x86_64-linux-gnu/libz.so;vtkftgl;vtkIOGeometry;vtkIOCore;/usr/lib/x86_64-linux-gnu/libjsoncpp.so;vtkFiltersModeling;vtkRenderingQt;vtkFiltersTexture;vtkGUISupportQt;vtkInteractionStyle;vtkRenderingOpenGL;vtkImagingHybrid;vtkIOImage;vtkDICOMParser;vtkmetaio;/usr/lib/x86_64-linux-gnu/libjpeg.so;/usr/lib/x86_64-linux-gnu/libpng.so;/usr/lib/x86_64-linux-gnu/libtiff.so;vtkRenderingLabel;vtkIOEnSight;vtkTestingGenericBridge;vtkIOParallel;vtkFiltersParallel;vtkParallelCore;vtkIOLegacy;vtkIONetCDF;/usr/lib/x86_64-linux-gnu/libnetcdf_c++.so;/usr/lib/x86_64-linux-gnu/libnetcdf.so;/usr/lib/x86_64-linux-gnu/hdf5/openmpi/lib/libhdf5.so;/usr/lib/x86_64-linux-gnu/libsz.so;/usr/lib/x86_64-linux-gnu/libdl.so;/usr/lib/x86_64-linux-gnu/libm.so;/usr/lib/x86_64-linux-gnu/hdf5/openmpi/lib/libhdf5_hl.so;/usr/lib/openmpi/lib/libmpi.so;vtkIOXML;vtkIOXMLParser;/usr/lib/x86_64-linux-gnu/libexpat.so;vtkexoIIc;vtkIOVPIC;VPIC;vtkTestingIOSQL;vtkIOSQL;sqlite3;vtkIOMovie;/usr/lib/x86_64-linux-gnu/libtheoraenc.so;/usr/lib/x86_64-linux-gnu/libtheoradec.so;/usr/lib/x86_64-linux-gnu/libogg.so;vtkIOParallelLSDyna;vtkIOLSDyna;vtkWrappingTools;vtkImagingStencil;vtkViewsCore;vtkInteractionWidgets;vtkFiltersHybrid;vtkImagingSources;vtkImagingGeneral;vtkRenderingVolume;vtkDomainsChemistry;vtkxdmf2;/usr/lib/x86_64-linux-gnu/libxml2.so;vtkRenderingExternal;vtkFiltersParallelImaging;vtkFiltersImaging;/usr/lib/libgl2ps.so;vtkIOMINC;vtkParallelMPI4Py;vtkParallelMPI;/usr/lib/x86_64-linux-gnu/libpython2.7.so;vtkViewsQt;vtkViewsInfovis;vtkChartsCore;vtkInfovisCore;vtkRenderingContext2D;vtkInfovisLayout;vtkIOPLY;vtkInteractionImage;vtkIOParallelXML;vtkFiltersAMR;vtkIOVideo;vtkRenderingImage;vtkIOExodus;vtkPythonInterpreter;vtkFiltersProgrammable;vtkFiltersVerdict;verdict;vtkIOImport;vtkFiltersSelection;vtkWrappingPythonCore;vtkIOParallelExodus;vtkGeovisCore;vtkproj4;vtkRenderingLOD;vtkGUISupportQtWebkit;vtkRenderingGL2PS;vtkRenderingContextOpenGL;vtkIOXdmf2;vtkIOODBC;vtkFiltersPython;vtkFiltersFlowPaths;vtkRenderingParallelLIC;vtkRenderingLIC;vtkGUISupportQtOpenGL;vtkIOAMR;vtkFiltersGeneric;vtkRenderingMatplotlib;vtkIOMPIParallel;vtkFiltersReebGraph;vtkLocalExample;vtkIOMySQL;vtkViewsGeovis;vtkIOInfovis;vtkRenderingFreeTypeFontConfig;vtkGUISupportQtSQL;vtkImagingStatistics;vtkFiltersHyperTree;vtkIOMPIImage;vtkFiltersParallelFlowPaths;vtkIOExport;vtkIOGeoJSON;vtkWrappingJava;vtkFiltersSMP;vtkRenderingParallel;vtkFiltersParallelStatistics;vtkFiltersParallelGeometry;vtkIOPostgreSQL;vtkIOGDAL;vtkIOFFMPEG;vtkInfovisBoostGraphAlgorithms;vtkTestingRendering;vtkImagingMorphological;vtkIOParallelNetCDF;vtkRenderingFreeTypeOpenGL;vtkRenderingVolumeOpenGL;vtkViewsContext2D;vtkFiltersParallelMPI")
    endif(VTK_FOUND)
  endif()
endmacro(find_VTK)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/aditya/CSE180/src/pcl-pcl-1.7.2")
...
set(pcl_all_components  common kdtree octree search sample_consensus filters features io geometry visualization segmentation people registration keypoints outofcore surface tracking recognition )
